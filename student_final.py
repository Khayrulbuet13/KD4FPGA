...
MODEL = 'resnet50_qt-1channel-no_normalize'
...
def main():
    ...
    teacher_model.load_state_dict(torch.load('checkpoint/Final_models/Teacher_imsize-no-normalize_20 October 22:45.pt', map_location=device))
